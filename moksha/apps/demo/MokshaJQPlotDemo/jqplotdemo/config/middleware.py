...
def make_app(global_conf, full_stack=True, **app_conf):
    """
    Set JQPlotDemo up with the settings found in the PasteDeploy configuration
    file used.

    :param global_conf: The global settings for JQPlotDemo (those
        defined under the ``[DEFAULT]`` section).
    :type global_conf: dict
    :param full_stack: Should the whole TG2 stack be set up?
    :type full_stack: str or bool
    :return: The JQPlotDemo application with all the relevant middleware
        loaded.

    This is the PasteDeploy factory for the JQPlotDemo application.
