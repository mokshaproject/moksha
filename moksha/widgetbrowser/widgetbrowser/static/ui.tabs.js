        ...
        tabify: function(init) {
            ...
            this.$tabs.each(function(i, a) {
                ...
                // remote tab
                    ...
                    var _cls = a.getAttribute('class');
                    var use_iframe = _cls && (_cls.indexOf('use_iframe') > -1)? true: false;
                    if (!use_iframe) {
                        $.data(a, 'load.tabs', a.href); // mutable
                    } else {
                        $.data(a, 'load.iframe_src', a.href); // mutable
                    }
                    ...
                    a.href = '#' + id;
                    var $panel = $('#' + id);
                    var panelTemplate = use_iframe? '<div><iframe></iframe></div>': o.panelTemplate;
                    if (!$panel.length) {
                        $panel = $(panelTemplate).attr('id', id).addClass(o.panelClass)
